...
<form action="../../../back_end/controladores/empleados_controlador.php" 
...
<input type="hidden" name="opcion" value="2">
 ...
 <div class="col-md-7 mb-7">
    ...
    <div class="col-md-7 mb-6">
      ...
      value="<?php echo $empleados->nombre ?>" required>
      <div class="valid-feedback">
      Dato validado!
      </div>
    </div>
  ...
  <div class="col-md-7 mb-7">
      ...
      value="<?php echo $empleados->apellido1 ?>" required>
      <div class="valid-feedback">
      Dato validado!
      </div>
    </div>
  ...
  <div class="col-md-7 mb-7">
      ...
      value="<?php echo $empleados->apellido2 ?>" required>
      <div class="valid-feedback">
      Dato validado!
      </div>
    </div>
  ...
  <div class="col-md-7 mb-7">
      ...
      value="<?php echo $empleados->Correo ?>" required>
      <div class="valid-feedback">
      Dato validado!
      </div>
    </div>
  ...
  <div class="col-md-7 mb-7">
      ...
      value="<?php echo $empleados->Clave ?>" required>
      <div class="valid-feedback">
      Dato validado!
      </div>
    </div>
  ...
  <div class="col-md-7 mb-7">
      ...
      <input type="hidden" name="foto_actual" value="<?php echo $empleados->foto ?>">
      <div class="valid-feedback">
      Dato validado!
      </div>
    </div>
