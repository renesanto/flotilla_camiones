...
<input type="hidden" name="opcion" value="2">
 ...
 <div class="col-md-7 mb-7">
    ...
    <div class="col-md-7 mb-6">
      ...
      value="<?php echo $vehiculos->capacidad ?>" required>
      <div class="valid-feedback">
      Dato validado!
      </div>
    </div>
  ...
  <div class="col-md-7 mb-7">
      ...
      value="<?php echo $vehiculos->modelo ?>" required>
      <div class="valid-feedback">
      Dato validado!
      </div>
    </div>
  ...
  <div class="col-md-7 mb-7">
      ...
      value="<?php echo $vehiculos->color ?>" required>
      <div class="valid-feedback">
      Dato validado!
      </div>
    </div>
  ...
  <div class="col-md-7 mb-7">
      ...
      value="<?php echo $vehiculos->poliza ?>" required>
      <div class="valid-feedback">
      Dato validado!
      </div>
    </div>
  ...
  <div class="col-md-7 mb-7">
      ...
      <img src="../../public/imagenes/clientes/<?php echo $vehiculos->foto ?>" alt="" width="150px">
      <input type="file" accept="image/*" class="form-control" name="foto" id="validationCustom02"> 
      <input type="hidden" name="foto_actual" value="<?php echo $vehiculos->foto ?>">
      <div class="valid-feedback">
      Dato validado!
      </div>
    </div>
  ...
  <div class="col-md-7 mb-6">
      ...
      <input type="text" class="form-control" name="capacidad" id="validationCustom02" 
      value="<?php echo $vehiculos->costo_mensual ?>" required>
      <div class="valid-feedback">
      Dato validado!
      </div>
    </div>
