...
<input type="hidden" name="opcion" value="1">
 ...
 <div class="col-md-7 mb-7">
  ...
  <div class="col-md-7 mb-7">
      ...
      <input type="text" class="form-control" name="poliza" id="validationCustom02"  required>
    </div>
  </div>
  ...
  <div class="col-md-7 mb-7">
      ...
      <input type="text" class="form-control" name="costo_mensual" id="validationCustom02"  required>
    </div>
  </div>
