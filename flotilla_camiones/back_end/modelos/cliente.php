...
try{
 $sql = "INSERT INTO clientes (apellido1, apellido2, nombre, correo, clave, estatus, foto) 
...
$this->con=null;
    ...
    public function actualizar(){
        try{
        $sql= "UPDATE clientes SET apellido1=:apellido1, apellido2=:apellido2, nombre=:nombre,correo=:correo, clave=:clave, estatus=:estatus, foto=:foto 
        WHERE id=:id";
    $stmt = $this->con->prepare($sql);
       $stmt->bindParam(':apellido1', $this->apellido1);
       $stmt->bindParam(':apellido2', $this->apellido2);
