<?php
include('crud.php');
class Empleados implements CRUD{
    public $id;
    public $apellido1;
    public $apellido2;
    public $nombre;
    ...
    public function crear(){
        try{
         $sql = "INSERT INTO empleados (apellido1, apellido2, nombre,clave, estatus, foto) 
        ...
        $this->con=null;
            ...
            public function actualizar(){
                try{
                $sql= "UPDATE empleados SET apellido1=:apellido1, apellido2=:apellido2, nombre=:nombre, estatus=:estatus, foto=:foto 
                WHERE id=:id";
            $stmt = $this->con->prepare($sql);
               $stmt->bindParam(':apellido1', $this->apellido1);
               $stmt->bindParam(':apellido2', $this->apellido2);
